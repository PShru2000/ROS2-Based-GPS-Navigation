...
#include <stddef.h>
#include "gps_msgs/msg/detail/gps_msg__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember gps_msgs__msg__GpsMsg__rosidl_typesupport_introspection_c__GpsMsg_message_member_array[10] = {
  {
    "header",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(gps_msgs__msg__GpsMsg, hdop),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(gps_msgs__msg__GpsMsg, utc),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
