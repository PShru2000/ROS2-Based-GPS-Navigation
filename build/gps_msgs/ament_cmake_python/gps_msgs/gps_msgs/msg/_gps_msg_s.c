...
bool gps_msgs__msg__gps_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("gps_msgs.msg._gps_msg.GpsMsg", full_classname_dest, 28) == 0);
  }
...
PyObject * gps_msgs__msg__gps_msg__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("gps_msgs.msg._gps_msg");
